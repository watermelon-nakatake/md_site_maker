...
#06.設置者のアドレス(カンマ区切り)
$conf{'mailto'} = 'kirishima3260@gmail.com';

#07.送信完了時にリダイレクトするサンクスページ
$conf{'thanks'} = 'http://www.demr.jp/pc/reviews/thanks.html';

#08.設置者に届くメールの件名
$conf{'subject'} = '例文集口コミ投稿';

#09.送信者に届くメールの件名
$conf{'res_subject'} = '口コミ投稿ありがとうございます';

#10.送信者に届くメールの本文
$conf{'res_body'} = <<'__res_body_eof__';
この度は口コミ情報を投稿頂き誠にありがとうございました。
貴重な情報として参考にいたします。
