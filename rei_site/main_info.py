...
add_files = ['rei_site/html_files/index.html',
             'rei_site/html_files/pc/css/main.css', 'rei_site/html_files/sitemap.xml']

main_dir = 'pc/'
article_image_dir = 'art_images'
amp_flag = False
default_img = 'common/rs_image.jpeg'
h_sitemap_path = 'rei_site/html_files/pc/sitemap/sm1.html'
...
upload_data = {'host_name': 'blackrhino1.sakura.ne.jp', 'password_str': 'k2u5n47ku6', 'user_name': 'blackrhino1',
               'upload_dir': 'rs'}
sc_url = {'口コミランキング': 'site/ranking.html', '口コミ評価ランキング': 'site/ranking.html',
